...
import com.linkedgrails.Permissao
import com.linkedgrails.Pessoa
import com.linkedgrails.Usuario
import com.linkedgrails.UsuarioPermissao

class BootStrap {

    def init = { servletContext ->

        def usuario = new Usuario(password: '123',
                username: 'grails').save(failOnError:true, flush: true)
        ...
        UsuarioPermissao autorizacaoAdministrador = new
                UsuarioPermissao(
                usuario: usuario,permissao:permissaoAdministrador).
